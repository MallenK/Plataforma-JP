...
class MailService
{
    ...
    private const DEFAULT_FROM = 'URPA <noreply@urpa.example>';
        ...
        $body = '
            <div style="font-family:sans-serif;max-width:480px;margin:auto;color:#0f172a">
                ...
                <p style="margin-top:0">La contraseña de tu cuenta de
                   <strong>URPA</strong> se ha cambiado
                ...
                <p style="color:#b91c1c">Si <u>no</u> has sido tú, tu cuenta puede estar
                   ...
                   y avisa al equipo de URPA.</p>
                <p style="color:#888;font-size:12px;margin-top:24px">
                    Este es un aviso automático de seguridad.
                </p>
            </div>';

        return $this->send($to, 'Tu contraseña de URPA ha cambiado', $body, [
            'sender_id'      => 0,
            'recipient_type' => 'individual',
        ]);
    }
        ...
        return '
            <div style="font-family:sans-serif;max-width:480px;margin:auto;color:#0f172a">
                ...
                <p style="margin-top:0">Se ha creado tu cuenta de <strong>' . esc($roleLabel) . '</strong>
                   en la plataforma de <strong>URPA</strong>.</p>
                ' . $credentialsBlock . '
                <a href="' . $loginUrl . '"
                ...
                <p style="color:#888;font-size:12px;margin-top:24px">
                    Si no esperabas este correo, puedes ignorarlo o avisar al equipo de URPA.
                </p>
            </div>
        ';
    }
