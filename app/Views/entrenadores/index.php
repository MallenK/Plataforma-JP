...
<div class="alert-jp success" style="display:flex;align-items:flex-start;gap:12px;margin-bottom:16px">
    ...
    <div>
        ...
        <div class="d-flex align-items-center gap-2 mt-1">
            <code id="newPwdValue-entrenadores" style="background:rgba(255,255,255,.15);padding:2px 8px;border-radius:4px;font-weight:700;letter-spacing:.5px">
                <?= esc(session()->getFlashdata('created_password')) ?>
            </code>
            <button type="button" class="btn-jp btn-jp-secondary btn-jp-sm"
                    onclick="navigator.clipboard.writeText(document.getElementById('newPwdValue-entrenadores').textContent.trim()); this.innerHTML='<i class=\'bi bi-check-lg\'></i> Copiada'">
